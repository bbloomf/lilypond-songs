...
copy !full.pdf sftpd.pdf
copy !full.pdf 9781484022801_content.pdf
pdftk A=sftpd.pdf cat Aodd output odd.pdf
pdftk A=sftpd.pdf cat Aeven output even.pdf
...
gswin64c -o sftpd-playbook.pdf -dBATCH -dNOPAUSE -sDEVICE=pdfwrite -c "[/CropBox [27 18 585 774] /PAGES pdfmark" -f !sftpd-playbook.pdf pdfmarks.txt
