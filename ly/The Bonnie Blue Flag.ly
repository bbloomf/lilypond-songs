...
sopWordsII = \lyricmode {
  ...
  Like friends _ and like breth -- _ ren, "" kind we were, and just, __ _
  But now, when North -- ern trea -- _ cher -- y at -- tempts our rights to mar __ _
...
sopWordsIII = \lyricmode {
  \set stanza = #"3. "
  \set ignoreMelismata = ##t
  Then here’s to our Con -- fed -- e -- ra -- cy, "" strong we are and brave, _
