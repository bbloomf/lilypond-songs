...
\header {
  title = \markup{\override #'(font-name . "Garamond Premr Pro Smdb Subh"){ \abs-fontsize #18 \smallCapsOldStyle"Praise of Spring"}}
  subtitle = \markup{\override #'(font-name . "Garamond Premr Pro"){ \abs-fontsize #12.5 "(Lob des Frühlings)"}}
