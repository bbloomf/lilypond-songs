...
#(set-global-staff-size 17.6) \paper{ #(define fonts (make-pango-font-tree "Garamond Premr Pro" "Garamond Premr Pro" "Garamond Premr Pro" (/ 17.6 20))) }
global = {
  \key g \major
  \time 2/2
  \dynamicUp
...
\header {
  title = \markup{\override #'(font-name . "Garamond Premr Pro Smdb Subh"){ \abs-fontsize #18 \smallCapsOldStyle"It was a lover and his lass"}}
