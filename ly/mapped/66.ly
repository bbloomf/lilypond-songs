...
#(set-global-staff-size 17.5) \paper{ #(define fonts (make-pango-font-tree "Garamond Premr Pro" "Garamond Premr Pro" "Garamond Premr Pro" (/ 17.5 20))) }
global = {
  \key ees \major
  \time 4/4
  \dynamicUp
...
\header {
  title = \markup{\override #'(font-name . "Garamond Premr Pro Smdb Subh"){ \abs-fontsize #18 \smallCapsOldStyle"Dreaming of Home and Mother"}}
