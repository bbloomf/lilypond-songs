...
\header {
  title = \markup{\override #'(font-name . "Garamond Premr Pro Smdb Subh"){ \abs-fontsize #18 \smallCapsOldStyle"Hail! Smiling Morn"}}
...
sopWordsII = \lyricmode {
  When the bells are sweet -- ly ring -- ing, sweet -- ly ring -- ing!
}
...
\header {
  title = \markup{\override #'(font-name . "Garamond Premr Pro Smdb Subh"){ \abs-fontsize #18 \smallCapsOldStyle"How Lovely Is the Evening"}}
